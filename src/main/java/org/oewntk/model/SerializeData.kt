 ...
 * @return lex hypermap
 */
fun Sequence<Lex>.lexesDataSerialize(): Map<String, Any> {
 ...
 * @return synset map
 */
fun Sequence<Synset>.synsetsDataSerialize(): Map<String, Any> {
    return synsetsById()
}
 ...
 * @return synset map
 */
fun Sequence<Sense>.sensesDataSerialize(): Map<String, Any> {
    return sensesById()
}
